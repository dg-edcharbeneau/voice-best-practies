...
// token. We use a raw WebSocket so we can receive the *binary* audio frames
// directly: binaryType = "arraybuffer", treat binary frames as audio (linear16
// PCM) and text frames as JSON control messages (Metadata / Flushed / Cleared /
// Warning).
//
