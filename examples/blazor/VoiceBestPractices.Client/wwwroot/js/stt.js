...
//
// Why a raw WebSocket (and not an SDK)? Authenticating a browser WebSocket to
// Deepgram is done with the Sec-WebSocket-Protocol subprotocol, which we do here
// with our short-lived token: `new WebSocket(url, ["bearer", token])`.
//
